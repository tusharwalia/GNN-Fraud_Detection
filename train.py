...
parser.add_argument('--model', type=str, default='FD', help='The model name. [FD, SAGE]')
...
if args.model == 'FD':
	gnn_model = OneLayerFD(2, inter1, args.lambda_1)
elif args.model == 'SAGE':
...
for epoch in range(args.num_epochs):
	...
	if epoch % args.test_epochs == 0:
		if args.model == 'SAGE':
			...
			gnn_auc, label_auc, gnn_recall, label_recall = test_FD(idx_test, y_test, gnn_model, args.batch_size)
